...
export const MarketingProfileCard: React.FC<{ artisanId: string }> = ({ artisanId }) => {
  ...
  if (loading) {
    return (
      <div className="scp-shell min-h-screen text-white flex flex-col items-center justify-center p-6 animate-pulse">
  ...
  if (!artisan) {
    return (
      <div className="scp-shell min-h-screen text-white flex flex-col items-center justify-center p-6 text-center">
        ...
        <button onClick={() => window.location.href = '/'} className="scp-btn scp-btn-primary !px-8 !py-4">Return to Network</button>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#150f0a] text-white pt-24 pb-20 px-4 md:px-8 relative overflow-hidden">
      ...
      <div className="fixed inset-0 z-0 bg-[#0c0906]">
        <Image
          ...
          fill
          priority
          className="object-cover animate-deep-breathing mix-blend-luminosity"
          sizes="100vw"
        />
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto flex flex-col items-center gap-12 text-center">
        ...
        <div className="scp-chip !text-brand-yellow !border-brand-yellow/30 !bg-white/5 !px-6 !py-2.5 !text-[10px] md:!text-xs !tracking-[0.3em] shadow-[0_0_30px_rgba(250,204,21,0.15)] flex items-center gap-2">
          ⚡ Limited VIP Access
        </div>

        <h1 className="scp-heading-xl text-white max-w-4xl mx-auto drop-shadow-2xl">
        ...
        <p className="scp-text-lg max-w-2xl drop-shadow-lg">
        ...
        <div className="relative group w-full max-w-5xl mx-auto mt-8 card-3d">
          ...
          <div className="relative scp-card p-8 sm:p-10 md:p-14 flex flex-col md:flex-row items-center justify-between gap-10 md:gap-12 text-center md:text-left rounded-[2rem] md:rounded-[3rem] overflow-hidden">
            ...
            <div className="flex-1 space-y-4 relative z-10">
              ...
              <h2 className="text-4xl sm:text-5xl md:text-6xl font-black uppercase italic tracking-tighter text-white leading-[0.95] drop-shadow-xl">{artisan.name}</h2>
              <p className="text-lg sm:text-xl font-bold tracking-[0.14em] uppercase text-brand-yellow drop-shadow-md">{artisan.category} • {artisan.location}</p>
              <div className="scp-soft-divider max-w-md"></div>
              <p className="scp-text-body max-w-xl">
                Share this profile card with clients to build trust faster and drive quality inbound leads through your verified network presence.
              </p>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16 relative z-10">
              ...
              <div className="relative w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden border-[6px] border-white/20 shadow-[0_0_40px_rgba(250,204,21,0.2)] transform group-hover:scale-105 group-hover:border-brand-yellow/50 transition-all duration-500 ring-1 ring-brand-yellow/20 group-hover:ring-brand-yellow/50">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-4 mt-14 w-full max-w-2xl mx-auto px-4 relative z-10">
          {/* WhatsApp Button - Vibrant Gradient */}
          <a
            href={whatsappShareUrl} 
            target="_blank"
            rel="noopener noreferrer"
            className="scp-btn flex-1 group relative !py-5 !rounded-2xl !text-[11px] bg-gradient-to-r from-emerald-500 to-emerald-700 border border-emerald-400/50 text-white shadow-[0_10px_30px_rgba(16,185,129,0.3)] hover:scale-[1.02] hover:shadow-[0_15px_40px_rgba(16,185,129,0.5)] overflow-hidden"
            aria-label="Share profile card via WhatsApp"
          >
          ...
          <a
            ...
            className="scp-btn scp-btn-secondary flex-1 group relative !py-5 !rounded-2xl !text-[11px] shadow-[0_10px_30px_rgba(0,0,0,0.3)] hover:bg-brand-yellow hover:text-black hover:border-brand-yellow hover:scale-[1.02] hover:shadow-[0_15px_40px_rgba(250,204,21,0.4)]"
            aria-label="Visit full profile"
          >
        ...
        <div className="mt-32 text-center max-w-2xl mx-auto space-y-6 relative z-10">
          ...
          <h2 className="text-3xl sm:text-4xl font-black mb-8 tracking-tighter text-white drop-shadow-lg">Unlock Your Business Potential Locally</h2>
